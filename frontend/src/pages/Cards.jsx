...
function Cards() {
  return (
    ...
    <div className="flex flex-col items-center pl-3  bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-5xl hover:bg-gray-100 dark:border-gray-700 dark:bg-white ">
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <span className='flex justify-end h-10 w-10'><img src="https://png.pngtree.com/png-vector/20190215/ourmid/pngtree-vector-cancel-icon-png-image_533028.jpg" alt="" className='rounded-full '/></span>
        </div>
    </div>
    </div>
